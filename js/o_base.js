 ...
 */
// 请求ajax
function ajaxPost(Param, url, callback, error) {
    $.ajax({
        type: "POST",
        url: "http://tzshg.app.xiaozhuschool.com/Wxsite/" + url, // ajax请求路径
        dataType: "JSON",
        data: Param,
        async: true,
...
function ajaxPost1(Param, url, callback, error) {
    Param.token = "oKYxK0jkShSOVDEk5RGVkErI_-_Y"
    $.ajax({
        type: "POST",
        url: "http://tzshg.app.xiaozhuschool.com/Wxsite/" + url, // ajax请求路径
        dataType: "JSON",
